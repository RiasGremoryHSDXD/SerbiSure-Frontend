                ...
                <>
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <div className="font-extrabold font-display">Superadmin</div>
                        <div className={`text-[10px] font-normal ${currentRole === 'SUPERADMIN' ? 'text-zinc-300' : 'text-zinc-400'}`}>
                          All Barangays (Citywide)
                        </div>
                      </div>
                    </div>
